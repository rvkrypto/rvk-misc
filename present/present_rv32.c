...
#define RV32_XPERM4_S64(p, x)			  \
	(__riscv_xperm4_32((p) &0xFFFFFFFF, (x)) | \
	 __riscv_xperm4_32((p) >> 32, (x) ^ 0x88888888))

#define RV32_XPERM4_Q64(x0, x1, p) \
	(__riscv_xperm4_32((x0), (p)) | __riscv_xperm4_32((x1), (p) ^ 0x88888888))
...
#undef RV32_XPERM4_S64
#undef RV32_XPERM4_Q64
