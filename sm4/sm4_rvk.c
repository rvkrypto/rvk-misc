//	sm4_rvk.c
//	2020-01-27	Markku-Juhani O. Saarinen <mjos@iki.fi> See LICENSE.
...
//	SSM4_ED_X4	is a block of four sm4.ed instructions:

#define SSM4_ED_X4(rs1, rs2) {				\
	rs1 = __riscv_sm4ed(rs1, rs2, 0);		\
	rs1 = __riscv_sm4ed(rs1, rs2, 1);		\
	rs1 = __riscv_sm4ed(rs1, rs2, 2);		\
	rs1 = __riscv_sm4ed(rs1, rs2, 3);		\
}
...
//	SSM4_KS_X4	is a block of four sm4.ks instructions:

#define SSM4_KS_X4(rs1, rs2) {				\
	rs1 = __riscv_sm4ks(rs1, rs2, 0);		\
	rs1 = __riscv_sm4ks(rs1, rs2, 1);		\
	rs1 = __riscv_sm4ks(rs1, rs2, 2);		\
	rs1 = __riscv_sm4ks(rs1, rs2, 3);		\
}
